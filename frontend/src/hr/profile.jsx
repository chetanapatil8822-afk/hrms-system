...
import HRSidebar from '../components/HRSidebar'; // Cleaned casing reference to prevent compilation drops
...
export default function HRProfile() {
  ...
  // 🌐 Helper to stream files safely in a new browser window tab index
  const handleViewDocument = (filename) => {
    if (!filename) {
      toast.error("⚠️ Document target resource does not exist for this account.");
      return;
    }
    // Hits the static express upload directory route configured on your backend
  ...
  // 📦 Build a clean structural array out of fields dynamically queried from MongoDB
